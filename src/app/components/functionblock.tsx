...
// import {TYPE_SELECT_KEY, ActionName, listActions, DisplayList, typeSelect, getSelectedSocket, typeLabels} from './elementary/node';
...
//       let typeName = Data.getControlsData(n)[TYPE_SELECT_KEY];
...
//       let name = Data.getControlsData(n)[FUNCTION_VARIABLE_NAMEVAR];
...
//         let nameData = Data.getControlsData(n)[FUNCTION_BLOCK_NAMEVAR];
...
//               // clear data
//               _functionNode && delete Data.getControlsData(_functionNode)[i.key];
